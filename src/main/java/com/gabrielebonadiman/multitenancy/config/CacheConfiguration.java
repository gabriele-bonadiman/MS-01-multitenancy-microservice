...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("multitenancy");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("multitenancy");
        ...
        config.getMapConfigs().put("com.gabrielebonadiman.multitenancy.domain.*", initializeDomainMapConfig(jHipsterProperties));
